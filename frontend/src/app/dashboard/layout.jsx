...
const navItems = {
  ...
  user: [
    ...
    { href: "/dashboard/user/donations", label: "Make Donation", icon: HandCoins },
    { href: "/dashboard/user/help", label: "Help & Support", icon: HelpCircle },
  ],
  volunteer: [
    { href: "/dashboard/volunteer", label: "Overview", icon: LayoutDashboard },
    { href: "/dashboard/volunteer/tasks", label: "Assigned Tasks", icon: ClipboardCheck },
    { href: "/dashboard/volunteer/reports", label: "Progress Reports", icon: FileText },
  ],
  donor: [
