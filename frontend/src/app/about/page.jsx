    ...
    <div className="bg-gray-50 text-gray-800">
      ...
      <section className="py-16 bg-gray-100 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-6xl mx-auto">
          {[
            { name: "Ali Khan", role: "Team Lead", img: "https://randomuser.me/api/portraits/men/32.jpg" },
            { name: "Sara Ahmed", role: "Backend Developer", img: "https://randomuser.me/api/portraits/women/44.jpg" },
            { name: "Bilal Hussain", role: "Frontend Developer", img: "https://randomuser.me/api/portraits/men/52.jpg" },
          ].map((member, idx) => (
